...
export const CATEGORIES: Category[] = [
  {
    ...
    intro:
      "AussieVapes is Australia's largest stockist of disposable vapes, with over 1,700 authentic devices across 30+ brands all in stock and ready for same-day Sydney dispatch.",
    longDescription:
      "Disposable vapes are the most popular vaping format in Australia for one simple reason — they just work. No coil changes, no e-liquid refills, no setup, no maintenance. You unbox it, you vape it, and when it's done you safely dispose of it. AussieVapes carries the deepest disposable vape range in Australia, spanning every puff tier and price point. At the entry level, the IGET Shion 600, X-Qlusive 2500 and Gunnpod 2000 are the go-to recommendations for ex-smokers transitioning to vaping. In the mid-range, the IGET Bar 3500, HQD Cuvie Plus 1200 and Mr Fog Max Air 3600 strike the best balance of cost, capacity and flavour. The 5000-8000 puff tier — IGET Goat 5000, IGET Hot 5500, HQD Slick 6000, Gunnpod Moss 8000, Alfakher Crown Bar 8000 — is where most Australian vapers settle in, offering 5-10 days of moderate use per device with USB-C rechargeable batteries. At the top end, the IGET One 12,000, Alfakher Crown Bar 15,000, HQD Cuvie Slick 20,000 and Kuz Flow 25,000 deliver weeks of vaping per device. All disposables sold at AussieVapes are authentic, age-verified at checkout, and dispatched same-day from our Sydney warehouse on weekday orders placed before 2pm AEST.",
    highlights: [
    ...
    seoTitle: 'Disposable Vapes Australia — 1700+ In Stock | AussieVapes',
    seoDescription:
      'Buy disposable vapes online in Australia. 1,700+ devices from IGET, Alfakher, HQD, Gunnpod, Lost Mary & more. Same-day Sydney shipping, free over $100.',
    keywords: [
    ...
    faqs: [
      {
        ...
        answer:
          'Disposable vapes containing nicotine are legal in Australia under the TGA prescription model — you must hold a valid Australian prescription to legally possess them. AussieVapes operates within this framework and includes prescription confirmation at checkout. Non-nicotine disposable vapes are also available and require no prescription.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Entry-level disposables (600-2,500 puffs) typically cost $14.95-$22.95 at AussieVapes. Mid-range (3,500-6,000 puffs) range from $24.95-$32.95. High-capacity (8,000-15,000 puffs) sit between $35-$47. Ultra-high capacity (20,000+ puffs) reach $55-$60. Bulk packs (3-pack, 5-pack, 10-pack) discount per-unit prices by 10-20%.',
      },
      {
        question: 'Do you ship disposable vapes Australia-wide?',
        answer:
          'Yes. AussieVapes ships to every Australian state and territory using discreet plain-packaging couriers. Free shipping on orders over $100. Express options available at checkout. Same-day Sydney dispatch on weekday orders placed before 2pm AEST.',
      },
      {
        question: "What's the difference between 20mg and 50mg disposables?",
        answer:
          'In Australia, all legally-sold nicotine disposables are capped at 20mg/mL (2%) under TGA regulations. 50mg devices that some overseas sites sell are not compliant with Australian law. AussieVapes only sells TGA-compliant 20mg disposables, which is more than enough nicotine for any vaper.',
      },
      {
  ...
  },
  {
    ...
    seoTitle: 'Pod Systems Australia — Refillable Vape Kits | AussieVapes',
    seoDescription:
      'Shop refillable pod systems & vape kits in Australia. Beginner to advanced, 12-month AU warranty, save 70% vs disposables long-term.',
    keywords: [
  ...
  },
  {
    ...
    longDescription:
      "Nicotine salt e-liquids are the gold standard for pod systems. By combining freebase nicotine with benzoic acid (or another suitable acid), the nicotine becomes more bioavailable at lower wattages — the kind of low wattages pod systems and disposable vapes run at. The practical result: salt liquids deliver a smoother, faster nicotine hit at higher concentrations (20mg+) without the harsh throat hit that high-strength freebase causes. AussieVapes carries a curated selection of Australian-made and imported nicotine salt e-liquids in 30mL bottles, with strengths from 25mg to 50mg and a flavour range covering fruit, menthol, dessert and tobacco profiles.",
    highlights: [
    ...
    seoTitle: 'Nicotine Salts Australia — Nic Salt E-Liquid | AussieVapes',
    seoDescription:
      'Buy nicotine salt e-liquid in Australia. 30mL bottles, 25mg & 50mg, fruit/menthol/dessert flavours. Same-day Sydney shipping.',
    keywords: [
  ...
  },
  {
    ...
    seoTitle: 'E-Liquids Australia — Freebase Vape Juice | AussieVapes',
    seoDescription:
      'Buy freebase e-liquids in Australia. 70VG sub-ohm friendly vape juice, 3mg & 6mg, 30mL & 60mL bottles. Same-day Sydney shipping.',
    keywords: [
      'e-liquid australia',
  ...
  },
  {
    ...
    seoTitle: 'Vape Accessories Australia — Coils, Cables, Pouches | AussieVapes',
    seoDescription:
      'Buy vape accessories in Australia — replacement coils, USB-C cables, carrying cases and nicotine pouches. Same-day Sydney shipping.',
    keywords: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes — all replacement coils sold at AussieVapes are genuine OEM parts from the original device manufacturer, never aftermarket knock-offs.',
      },
      {
