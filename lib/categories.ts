...
export const CATEGORIES: Category[] = [
  {
    ...
    intro:
      "VapeHub Vapes Australia is Australia's largest stockist of disposable vapes, with over 1,700 authentic devices across 30+ brands all in stock and ready for same-day Sydney dispatch.",
    longDescription:
      "Disposable vapes are the most popular vaping format in Australia for one simple reason — they just work. No coil changes, no e-liquid refills, no setup, no maintenance. You unbox it, you vape it, and when it's done you safely dispose of it. VapeHub Vapes Australia carries the deepest disposable vape range in Australia, spanning every puff tier and price point. At the entry level, the IGET Shion 600, X-Qlusive 2500 and Gunnpod 2000 are the go-to recommendations for ex-smokers transitioning to vaping. In the mid-range, the IGET Bar 3500, HQD Cuvie Plus 1200 and Mr Fog Max Air 3600 strike the best balance of cost, capacity and flavour. The 5000-8000 puff tier — IGET Goat 5000, IGET Hot 5500, HQD Slick 6000, Gunnpod Moss 8000, Alfakher Crown Bar 8000 — is where most Australian vapers settle in, offering 5-10 days of moderate use per device with USB-C rechargeable batteries. At the top end, the IGET One 12,000, Alfakher Crown Bar 15,000, HQD Cuvie Slick 20,000 and Kuz Flow 25,000 deliver weeks of vaping per device. All disposables sold at VapeHub Vapes Australia are authentic, age-verified at checkout, and dispatched same-day from our Sydney warehouse on weekday orders placed before 2pm AEST.",
    highlights: [
    ...
    seoTitle: 'Disposable VapeHub Vapes Australia — 1,700+ In Stock | VapeHub Vapes Australia',
    seoDescription:
      'VapeHub Vapes Australia stocks 1,700+ disposable vapes online in Australia. IGET, Alfakher, HQD, Gunnpod, Lost Mary & 35+ brands. Same-day Sydney shipping, free over $300.',
    keywords: [
    ...
    faqs: [
      {
        ...
        answer:
          'Disposable vapes containing nicotine are legal in Australia under the TGA prescription model — you must hold a valid Australian prescription to legally possess them. VapeHub Vapes Australia operates within this framework and includes prescription confirmation at checkout. Non-nicotine disposable vapes are also available and require no prescription.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Entry-level disposables (600-2,500 puffs) typically cost $14.95-$22.95 at VapeHub Vapes Australia. Mid-range (3,500-6,000 puffs) range from $24.95-$32.95. High-capacity (8,000-15,000 puffs) sit between $35-$47. Ultra-high capacity (20,000+ puffs) reach $55-$60. Bulk packs (3-pack, 5-pack, 10-pack) discount per-unit prices by 10-20%.',
      },
      {
        question: 'Do you ship disposable vapes Australia-wide?',
        answer:
          'Yes. VapeHub Vapes Australia ships to every Australian state and territory using discreet plain-packaging couriers. Free shipping on orders over $300. Express options available at checkout. Same-day Sydney dispatch on weekday orders placed before 2pm AEST.',
      },
      {
        question: "What's the difference between 20mg and 50mg disposables?",
        answer:
          'In Australia, all legally-sold nicotine disposables are capped at 20mg/mL (2%) under TGA regulations. 50mg devices that some overseas sites sell are not compliant with Australian law. VapeHub Vapes Australia only sells TGA-compliant 20mg disposables, which is more than enough nicotine for any vaper.',
      },
      {
  ...
  },
  {
    ...
    longDescription:
      "Pod systems are the smartest long-term economic choice for Australian vapers. Where a disposable costs $25-$45 per device and lasts a week or two, a refillable pod system pays for itself in 4-6 weeks of regular use — and after that, the only ongoing cost is e-liquid (around $20-25 per 30mL bottle) and the occasional coil head. VapeHub Vapes Australia carries refillable pod kits across three tiers: ultra-slim draw-activated pods for new vapers and ex-smokers wanting a cigarette-like draw; mid-range refillable pods with variable wattage and bigger batteries; and advanced sub-ohm pod mods for experienced vapers chasing flavour and cloud production. All pod kits include the coil heads needed to get started, USB-C charging cables, and a 12-month Australian warranty on hardware.",
    highlights: [
    ...
    seoTitle: 'Pod Systems Australia — Refillable Vape Kits | VapeHub Vapes Australia',
    seoDescription:
      'VapeHub Vapes Australia stocks the best refillable pod systems & vape kits in Australia. Beginner to advanced, 12-month AU warranty, save 70% vs disposables long-term.',
    keywords: [
      'vapehub vapes australia pod systems',
      'aussie pod systems',
      'vapehub vapes australia vape kits',
      'vapehub vapes australia refillable',
  ...
  },
  {
    ...
    longDescription:
      "Nicotine salt e-liquids are the gold standard for pod systems. By combining freebase nicotine with benzoic acid (or another suitable acid), the nicotine becomes more bioavailable at lower wattages — the kind of low wattages pod systems and disposable vapes run at. The practical result: salt liquids deliver a smoother, faster nicotine hit at higher concentrations (20mg+) without the harsh throat hit that high-strength freebase causes. VapeHub Vapes Australia carries a curated selection of Australian-made and imported nicotine salt e-liquids in 30mL bottles, with strengths from 25mg to 50mg and a flavour range covering fruit, menthol, dessert and tobacco profiles.",
    highlights: [
    ...
    seoTitle: 'Nicotine Salts Australia — Nic Salt E-Liquid | VapeHub Vapes Australia',
    seoDescription:
      'VapeHub Vapes Australia stocks premium nicotine salt e-liquid in Australia. 30mL bottles, 25mg & 50mg, fruit/menthol/dessert flavours. Same-day Sydney shipping.',
    keywords: [
      'vapehub vapes australia nicotine salts',
      'aussie nicotine salts',
      'vapehub vapes australia nic salt',
      'vapehub vapes australia e-liquid',
  ...
  },
  {
    ...
    seoTitle: 'E-Liquids Australia — Freebase Vape Juice | VapeHub Vapes Australia',
    seoDescription:
      'VapeHub Vapes Australia stocks premium freebase e-liquids in Australia. 70VG sub-ohm friendly vape juice, 3mg & 6mg, 30mL & 60mL bottles. Same-day Sydney shipping.',
    keywords: [
      'vapehub vapes australia e-liquid',
      'vapehub vapes australia vape juice',
      'aussie e-liquid',
      'vape juice',
      'e-liquid australia',
  ...
  },
  {
    ...
    seoTitle: 'Vape Accessories Australia — Coils, Cables, Pouches | VapeHub Vapes Australia',
    seoDescription:
      'VapeHub Vapes Australia stocks genuine vape accessories in Australia — replacement coils, USB-C cables, carrying cases and nicotine pouches. Same-day Sydney shipping.',
    keywords: [
      'vapehub vapes australia accessories',
      'vape accessories',
      'vapehub vapes australia coils',
      'vapehub vapes australia pouches',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes — all replacement coils sold at VapeHub Vapes Australia are genuine OEM parts from the original device manufacturer, never aftermarket knock-offs.',
      },
      {
