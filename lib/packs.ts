...
export const PACK_GROUPS: PackGroup[] = [
  ...
  },
  {
    ...
    longDescription:
      "Aussie Vapes Multi-Buy Packs are 2-pack and 3-pack bundles sized for personal use. These are the perfect entry into pack pricing — try a couple of devices at once, mix flavours, or stock up your weekend kit without committing to a 10-pack carton. Multi-buy savings on Aussie Vapes typically range 8-15% per device vs single-unit pricing. Available across IGET, Alfakher, HQD, Gunnpod, Lost Mary, Vozol and 35+ more brands.",
    seoTitle: 'Multi-Buy Vape Packs Australia — 2-Pack & 3-Pack Deals | Aussie Vapes',
    seoDescription:
      "Aussie Vapes multi-buy packs. 2-pack and 3-pack bundles across IGET, Alfakher, HQD, Gunnpod, Lost Mary & 35+ brands. Same-day Sydney dispatch.",
    keywords: [
      'multi buy vape packs australia',
      'aussie vapes multi buy',
  ...
  },
  {
    ...
    longDescription:
      "Aussie Vapes Brand Packs feature pack-format products from the headline brands of the Australian disposable vape market: IGET, Alfakher Crown Bar, HQD, Gunnpod, Lost Mary, Vozol, RELX, Elux. If you're loyal to a specific brand, this is the page to find every pack size that brand offers in one place. All Aussie Vapes brand packs are authentic, sourced through authorised distribution channels, and ship same-day from Sydney.",
    seoTitle: 'Brand Vape Packs Australia — IGET, Alfakher, HQD, Gunnpod | Aussie Vapes',
    seoDescription:
      "Aussie Vapes brand-specific vape packs. IGET packs, Alfakher Crown Bar packs, HQD packs, Gunnpod packs and more. Authentic AU stock with same-day Sydney shipping.",
    keywords: [
