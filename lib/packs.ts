...
export const PACK_GROUPS: PackGroup[] = [
  {
    ...
    description: 'Every pack-format disposable vape stocked at Aussie Vape Hub. Save 10-25% per device vs single-unit pricing.',
    longDescription:
      "The Aussie Vape Hub Disposable Vape Packs collection brings together every pack-format disposable in our catalogue. Whether you're after a Crown Bar 15000 5-pack, an IGET Bar 10-pack, or a Lost Mary multi-buy, this is the fastest way to compare per-device pricing across 40+ brands. All Aussie Vape Hub pack-format disposables are TGA-compliant 20mg salt nicotine and ship same-day from our Sydney warehouse. Free shipping over $300 — and a pack will almost always qualify.",
    seoTitle: 'Disposable Vape Packs Australia — Save On Multi-Buy | Aussie Vape Hub',
    seoDescription:
      "Buy disposable vape packs online in Australia. 2-pack, 3-pack, 5-pack, 10-pack & bulk multi-buy bundles from IGET, Alfakher, HQD, Gunnpod & more. Aussie Vape Hub.",
    keywords: [
  ...
  },
  {
    ...
    longDescription:
      "Aussie Vape Hub Multi-Buy Packs are 2-pack and 3-pack bundles sized for personal use. These are the perfect entry into pack pricing — try a couple of devices at once, mix flavours, or stock up your weekend kit without committing to a 10-pack carton. Multi-buy savings on Aussie Vape Hub typically range 8-15% per device vs single-unit pricing. Available across IGET, Alfakher, HQD, Gunnpod, Lost Mary, Vozol and 35+ more brands.",
    seoTitle: 'Multi-Buy Vape Packs Australia — 2-Pack & 3-Pack Deals | Aussie Vape Hub',
    seoDescription:
      "Aussie Vape Hub multi-buy packs. 2-pack and 3-pack bundles across IGET, Alfakher, HQD, Gunnpod, Lost Mary & 35+ brands. Same-day Sydney dispatch.",
    keywords: [
      'multi buy vape packs australia',
      'aussie vape hub multi buy',
  ...
  },
  {
    ...
    description: 'The best discounts at Aussie Vape Hub — pack-format products where the bundle savings are deepest.',
    longDescription:
      "Bundle Deals at Aussie Vape Hub are pack-format products with the deepest per-unit discounts vs single purchase. These are the products our team negotiates hardest with distributors to bring you the lowest Aussie vape prices. New bundle deals land weekly — bookmark this page and check back. Same authentic stock, same 30-day return guarantee, same same-day Sydney dispatch.",
    seoTitle: 'Vape Bundle Deals Australia — Best Pack Discounts | Aussie Vape Hub',
    seoDescription:
      "Vape bundle deals from Aussie Vape Hub. The deepest pack discounts on IGET, Alfakher, HQD, Gunnpod and more. Save up to 25% per device. Same-day Sydney shipping.",
    keywords: [
      'vape bundle deals australia',
      'aussie vape hub bundles',
  ...
  },
  {
    ...
    icon: TagIcon,
    accentColor: '#2fb5d2',
    shortDescription: 'Pack-format devices from the major Aussie Vape Hub brands — IGET, Alfakher, HQD, Gunnpod & more.',
    description: 'Curated brand-specific pack selection from the heavy hitters of the Australian disposable vape market.',
    longDescription:
      "Aussie Vape Hub Brand Packs feature pack-format products from the headline brands of the Australian disposable vape market: IGET, Alfakher Crown Bar, HQD, Gunnpod, Lost Mary, Vozol, RELX, Elux. If you're loyal to a specific brand, this is the page to find every pack size that brand offers in one place. All Aussie Vape Hub brand packs are authentic, sourced through authorised distribution channels, and ship same-day from Sydney.",
    seoTitle: 'Brand Vape Packs Australia — IGET, Alfakher, HQD, Gunnpod | Aussie Vape Hub',
    seoDescription:
      "Aussie Vape Hub brand-specific vape packs. IGET packs, Alfakher Crown Bar packs, HQD packs, Gunnpod packs and more. Authentic AU stock with same-day Sydney shipping.",
    keywords: [
  ...
  },
  {
    ...
    description: 'Wholesale-style bulk packs (10+ devices) with the deepest per-unit discounts at Aussie Vape Hub.',
    longDescription:
      "Aussie Vape Hub Bulk Vape Packs are 10-pack, 20-pack, 50-pack and 100-pack cartons priced for heavy users, businesses, event organisers and B2B resellers. Per-unit savings on 10-pack tier disposables typically run 18-25%; 20-pack and 50-pack pricing unlocks even deeper discounts. For dedicated wholesale partnerships with net-30 terms see our /bulk page. Otherwise, every bulk pack on this page is in stock and dispatches same-day from Sydney.",
    seoTitle: 'Bulk Vape Packs Australia — 10, 20, 50 & 100 Pack Cartons | Aussie Vape Hub',
    seoDescription:
      "Aussie Vape Hub bulk vape packs. 10-pack, 20-pack, 50-pack and 100-pack cartons of authentic disposable vapes. Wholesale pricing, same-day Sydney dispatch.",
    keywords: [
      'bulk vape packs australia',
      'wholesale vape packs australia',
      'aussie vape hub bulk',
