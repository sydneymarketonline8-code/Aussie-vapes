...
export const BRANDS: Brand[] = [
  make({
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. VapeHub Vapes Australia ships IGET disposables to every Australian state and territory via discreet, plain-packaging courier. Free standard shipping on orders over $300, express options at checkout, and same-day dispatch from Sydney on weekday orders placed before 2pm AEST.',
      },
      {
    ...
    seoTitle: 'IGET Australia — Bar, Bar Plus, Goat & More | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Alfakher Crown Bar Australia — 15000 & 8000 Puffs | VapeHub Vapes Australia',
  ...
  make({
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'HQD devices are manufactured in Shenzhen, China by HQD Tech, one of the largest e-cigarette OEMs in the world. VapeHub Vapes Australia only stocks authentic HQD inventory imported through authorised channels.',
      },
    ],
    keywords: [
      'hqd australia',
    ...
    seoTitle: 'HQD Australia — Cuvie, Maxx, Slick & Box Range | VapeHub Vapes Australia',
  ...
  make({
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes — despite being one of the older models, the original Gunnpod 2000 remains in active production and consistently in stock at VapeHub Vapes Australia. It\'s still one of our top sellers, especially among customers who tried it first and prefer to stick with what works.',
      },
      {
    ...
    seoTitle: 'Gunnpod Australia — 2000, Plus, Wave, Lume & Moss | VapeHub Vapes Australia',
  ...
  make({
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'The original Lost Mary BM600 is non-rechargeable. Most newer Lost Mary models with 3000+ puffs are rechargeable via USB-C. Check the specific product page on VapeHub Vapes Australia — rechargeability is always listed in the specifications.',
      },
      {
    ...
    seoTitle: 'Lost Mary Australia — BM600 & Screen Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes — all current Vozol disposables in the VapeHub Vapes Australia range are USB-C rechargeable. Most ship with a charging cable in the box.',
      },
      {
    ...
    seoTitle: 'Vozol Australia — Gear 10000 & 9000-Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "RELX is the closed-pod and premium-disposable brand of choice for vapers who prioritise build quality, flavour consistency and refined hardware. Globally, RELX is the second-largest vape company after Juul, with a particularly strong presence in Asia, the Middle East and now Australia. The RELX MagicGo disposable line uses the same ceramic atomiser technology as the premium RELX pod systems — meaning cleaner, more accurate flavour reproduction and zero burnt-coil taste even at the end of life. VapeHub Vapes Australia carries the AU-compliant MagicGo range.",
    highlights: [
    ...
    seoTitle: 'RELX Australia — MagicGo 8000 Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Elux Australia — 15000 Puff Disposables | VapeHub Vapes Australia',
    seoDescription: 'Buy authentic Elux disposables in Australia. Elux 15000 long-life models with same-day Sydney shipping from VapeHub Vapes Australia.',
    aliases: ['elux'],
    accentColor: '#e91e63',
  }),
  make({
    ...
    longDescription:
      "Mr Fog is the dominant disposable vape brand in Canada and a strong seller across North America. Its Australian range centres on the Mr Fog 3600 — a rechargeable USB-C disposable with a balanced flavour line-up engineered for North American taste profiles. Mr Fog has built its reputation on no-marketing, no-hype, just-work hardware that doesn't surprise you. VapeHub Vapes Australia stocks Mr Fog through authorised channels.",
    highlights: [
    ...
    seoTitle: 'Mr Fog Australia — Max Air 3600 Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Serein Australia — Hunter 6000 & Mech-Pro 10000 | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Fisco is a smaller specialist brand with an interesting niche: pod-mod hybrid disposables. The Fisco XPod features a replaceable pod (more like a refillable pod system) while keeping the all-in-one simplicity of a disposable. The Fisco Mix Bar 12,000 takes a different approach with swappable flavour cartridges. VapeHub Vapes Australia stocks the AU-compliant Fisco range.",
    highlights: [
    ...
    seoTitle: 'Fisco Australia — XPod & Mix Bar Hybrids | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'AliBarBar Australia — 9000 Puff & Ingot Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'JNR Australia — PhoneVape, FalconX, Shisha Hookah | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Kuz is a relatively new brand that has made a name for itself with the Kuz Flow 25,000 — one of the highest-puff disposables available in Australia. The brand also offers the Kuz Lux 9000 and Kuz 6000 for mid-tier shoppers. All Kuz devices use USB-C charging, dual mesh coils, and large e-liquid reservoirs. VapeHub Vapes Australia is an authorised AU stockist.",
    highlights: [
    ...
    seoTitle: 'Kuz Australia — Flow 25000 & Lux 9000 | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "X-Qlusive (X-Q) caters to vapers who want a single brand with broad coverage. The X-Qlusive 2500 is an entry-level non-rechargeable option, the Mega 3500 sits in the sweet spot for new vapers, the X-POD 3800 introduces refillable pod versatility, and the X-PRO 5500 is the brand's flagship rechargeable disposable. VapeHub Vapes Australia stocks all four ranges.",
    highlights: [
    ...
    seoTitle: 'X-Qlusive Australia — 2500 to X-PRO 5500 | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Groo Australia — Slim 9000 & Max Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'VapeHub Australia — Disposable Vape Range | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Brisk Bar focuses almost entirely on the 5000-puff mid-range segment that suits most Australian vapers. The brand has avoided the temptation to chase ever-higher puff counts and instead invested in flavour development and consistent build quality at a price point that beats most competitors. The Brisk Bar 5000 is USB-C rechargeable with mesh coil engineering. VapeHub Vapes Australia stocks the full Brisk Bar range.",
    ...
    seoTitle: 'Brisk Bar Australia — 5000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Rabbeats brings a music-inspired aesthetic to the disposable vape market — devices feature LED light effects and an audio-cue design language. Beyond the styling, the underlying hardware is solid: USB-C rechargeable batteries, dual mesh coil systems, and large e-liquid reservoirs delivering reliable performance. VapeHub Vapes Australia carries the AU-compliant Rabbeats range.",
    ...
    seoTitle: 'Rabbeats Australia — Bar Disposable Vapes | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Picco is a focused brand that builds primarily one thing extremely well — the Picco 7000 puff disposable. The device packs 7,000 puffs of e-liquid into a compact form factor that fits comfortably in a pocket or small bag. USB-C rechargeable with a mesh coil and adjustable airflow on select flavours. VapeHub Vapes Australia stocks the full Picco AU flavour range.",
    ...
    seoTitle: 'Picco Australia — 7000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "iBuff is a quietly competent disposable brand that prioritises substance over marketing. The hardware uses higher-grade materials than typical mid-tier disposables — better mouthpieces, more uniform coil winding, and tighter manufacturing tolerances — but the brand passes those savings on through lower pricing. VapeHub Vapes Australia stocks the iBuff range.",
    ...
    seoTitle: 'iBuff Australia — Premium Mid-Range Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Pyro Australia — 6000 Puff Bold Flavour Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Olit focuses on the 10,000 puff long-life segment with disciplined attention to per-device pricing. The Olit 10000 uses dual mesh coil engineering and an 800mAh USB-C rechargeable battery in a robust industrial-design shell. VapeHub Vapes Australia stocks the full Olit AU flavour range.",
    ...
    seoTitle: 'Olit Australia — 10000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Puffmi has built its reputation in Australia on the Puffmi 5000 — a straightforward, reliable 5000-puff USB-C rechargeable disposable that does what it says on the tin. No gimmicks, no marketing hype, just a dependable mid-range device. VapeHub Vapes Australia stocks the Puffmi range.",
    ...
    seoTitle: 'Puffmi Australia — 5000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "VapSolo's Viking 12000 disposable is built for endurance — 12,000 puffs of e-liquid, an 850mAh USB-C rechargeable battery, dual mesh coil engineering, and an aluminium-bodied industrial design shell that feels substantial in the hand. VapeHub Vapes Australia stocks the full VapSolo Viking AU range.",
    ...
    seoTitle: 'VapSolo Australia — Viking 12000 Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Zoovoo Australia — Dragbar 6000 Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Higo Pro Mix Australia — Adjustable Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Tess takes a focused approach: one product, done well. The Tess LV 12,000 is a 12,000-puff USB-C rechargeable disposable with dual mesh coil engineering, 850mAh battery, and an industrial-design shell that feels closer to a premium pod system than a typical disposable. VapeHub Vapes Australia stocks the Tess LV 12000 in its full AU flavour range.",
    ...
    seoTitle: 'Tess Australia — LV 12000 Premium Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Wotofo Australia — nexBar Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Calibarn is a focused brand offering one well-built product: the Calibarn 6000. USB-C rechargeable, mesh coil, and a balanced flavour line-up at a price point that competes aggressively with bigger-name brands. VapeHub Vapes Australia stocks the Calibarn 6000 AU range.",
    ...
    seoTitle: 'Calibarn Australia — 6000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Lucky Wolf Australia — Aggressive Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Rival Bar competes in the 7000-puff tier against bigger-name brands by leaning into unusual flavour combinations that the mainstream brands don't attempt. The hardware is solid (USB-C rechargeable, mesh coil) but the brand's identity is really about the flavour menu. VapeHub Vapes Australia stocks the full Rival Bar AU range.",
    ...
    seoTitle: 'Rival Bar Australia — 7000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "VEIIK has been in the Australian vape market since the early disposable boom and has earned a reputation for reliable, no-nonsense hardware. The VEIIK 7000 disposable is USB-C rechargeable with dual mesh coil engineering. The brand also produces pod systems and starter kits. VapeHub Vapes Australia stocks the VEIIK AU range.",
    ...
    seoTitle: 'VEIIK Australia — 7000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Panda Australia — 2500 Puff Entry Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Waka Smash earns its name from the sturdier-than-average build quality. The shell uses reinforced construction that survives drops and tumbles better than typical plastic disposables. The Smash 6000 is USB-C rechargeable with dual mesh coil engineering. VapeHub Vapes Australia stocks the Waka Smash AU range.",
    ...
    seoTitle: 'Waka Smash Australia — 6000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Yooz Ultra 15000 is the brand's flagship — 15,000 puffs of e-liquid, dual mesh coil engineering, 850mAh USB-C rechargeable battery, and a premium aluminium-bodied industrial design. The brand positions itself in the premium tier alongside Alfakher Crown Bar and HQD Cuvie Slick. VapeHub Vapes Australia stocks the Yooz Ultra range.",
    ...
    seoTitle: 'Yooz Australia — Ultra 15000 Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    seoTitle: 'Bimo Australia — Crystal 12000 Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Adalya is one of the world's most respected shisha tobacco brands, particularly known for its rich, layered flavour development. The Adalya disposable vape line — Love 66 and Two Apples in 16,000-puff format — translates the brand's shisha flavour expertise into the modern disposable format. VapeHub Vapes Australia stocks the Adalya AU range.",
    ...
    seoTitle: 'Adalya Australia — 16000 Puff Shisha Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Funky Land takes a deliberately playful approach — vibrant colours, bold packaging, and fun branding sit alongside dependable mid-range hardware. The Funky Land 6000 is USB-C rechargeable with a mesh coil. Flavours lean toward the fun, fruity end of the spectrum. VapeHub Vapes Australia stocks the Funky Land AU range.",
    ...
    seoTitle: 'Funky Land Australia — 6000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Golit 15000 competes in the premium long-life disposable tier with one key differentiator: price. The device matches the puff count and rechargeable hardware of brands like Alfakher Crown Bar 15000 and HQD Cuvie Slick at a noticeably lower price point. Flavour engineering is solid if not exceptional. VapeHub Vapes Australia stocks the Golit AU range.",
    ...
    seoTitle: 'Golit Australia — 15000 Puff Disposables | VapeHub Vapes Australia',
  ...
  make({
    ...
    longDescription:
      "Leafbar Platinum is positioned as a premium-tier brand competing with the likes of RELX MagicGo and HQD Cuvie Slick in the refined-hardware segment. The platinum line uses higher-grade internal components, more uniform coil winding, and a more sophisticated flavour development approach than mid-tier brands. VapeHub Vapes Australia stocks the Leafbar Platinum AU range.",
    ...
    seoTitle: 'Leafbar Platinum Australia — Premium Disposables | VapeHub Vapes Australia',
