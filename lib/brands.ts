...
export const BRANDS: Brand[] = [
  ...
  make({
    ...
    seoTitle: 'Groo Australia — Slim 9000 & Max Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'VapeHub Australia — Disposable Vape Range | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Brisk Bar focuses almost entirely on the 5000-puff mid-range segment that suits most Australian vapers. The brand has avoided the temptation to chase ever-higher puff counts and instead invested in flavour development and consistent build quality at a price point that beats most competitors. The Brisk Bar 5000 is USB-C rechargeable with mesh coil engineering. AussieVapes stocks the full Brisk Bar range.",
    ...
    seoTitle: 'Brisk Bar Australia — 5000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Rabbeats brings a music-inspired aesthetic to the disposable vape market — devices feature LED light effects and an audio-cue design language. Beyond the styling, the underlying hardware is solid: USB-C rechargeable batteries, dual mesh coil systems, and large e-liquid reservoirs delivering reliable performance. AussieVapes carries the AU-compliant Rabbeats range.",
    ...
    seoTitle: 'Rabbeats Australia — Bar Disposable Vapes | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Picco is a focused brand that builds primarily one thing extremely well — the Picco 7000 puff disposable. The device packs 7,000 puffs of e-liquid into a compact form factor that fits comfortably in a pocket or small bag. USB-C rechargeable with a mesh coil and adjustable airflow on select flavours. AussieVapes stocks the full Picco AU flavour range.",
    ...
    seoTitle: 'Picco Australia — 7000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "iBuff is a quietly competent disposable brand that prioritises substance over marketing. The hardware uses higher-grade materials than typical mid-tier disposables — better mouthpieces, more uniform coil winding, and tighter manufacturing tolerances — but the brand passes those savings on through lower pricing. AussieVapes stocks the iBuff range.",
    ...
    seoTitle: 'iBuff Australia — Premium Mid-Range Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'Pyro Australia — 6000 Puff Bold Flavour Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Olit focuses on the 10,000 puff long-life segment with disciplined attention to per-device pricing. The Olit 10000 uses dual mesh coil engineering and an 800mAh USB-C rechargeable battery in a robust industrial-design shell. AussieVapes stocks the full Olit AU flavour range.",
    ...
    seoTitle: 'Olit Australia — 10000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Puffmi has built its reputation in Australia on the Puffmi 5000 — a straightforward, reliable 5000-puff USB-C rechargeable disposable that does what it says on the tin. No gimmicks, no marketing hype, just a dependable mid-range device. AussieVapes stocks the Puffmi range.",
    ...
    seoTitle: 'Puffmi Australia — 5000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "VapSolo's Viking 12000 disposable is built for endurance — 12,000 puffs of e-liquid, an 850mAh USB-C rechargeable battery, dual mesh coil engineering, and an aluminium-bodied industrial design shell that feels substantial in the hand. AussieVapes stocks the full VapSolo Viking AU range.",
    ...
    seoTitle: 'VapSolo Australia — Viking 12000 Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'Zoovoo Australia — Dragbar 6000 Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Higo Pro Mix devices feature a usable airflow adjustment ring that allows vapers to fine-tune their experience between tight MTL and looser RDL draws. This is unusual in the disposable space and gives Pro Mix users genuine flexibility from a single device. AussieVapes stocks the Higo Pro Mix AU range.",
    ...
    seoTitle: 'Higo Pro Mix Australia — Adjustable Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Tess takes a focused approach: one product, done well. The Tess LV 12,000 is a 12,000-puff USB-C rechargeable disposable with dual mesh coil engineering, 850mAh battery, and an industrial-design shell that feels closer to a premium pod system than a typical disposable. AussieVapes stocks the Tess LV 12000 in its full AU flavour range.",
    ...
    seoTitle: 'Tess Australia — LV 12000 Premium Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'Wotofo Australia — nexBar Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Calibarn is a focused brand offering one well-built product: the Calibarn 6000. USB-C rechargeable, mesh coil, and a balanced flavour line-up at a price point that competes aggressively with bigger-name brands. AussieVapes stocks the Calibarn 6000 AU range.",
    ...
    seoTitle: 'Calibarn Australia — 6000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'Lucky Wolf Australia — Aggressive Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Rival Bar competes in the 7000-puff tier against bigger-name brands by leaning into unusual flavour combinations that the mainstream brands don't attempt. The hardware is solid (USB-C rechargeable, mesh coil) but the brand's identity is really about the flavour menu. AussieVapes stocks the full Rival Bar AU range.",
    ...
    seoTitle: 'Rival Bar Australia — 7000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "VEIIK has been in the Australian vape market since the early disposable boom and has earned a reputation for reliable, no-nonsense hardware. The VEIIK 7000 disposable is USB-C rechargeable with dual mesh coil engineering. The brand also produces pod systems and starter kits. AussieVapes stocks the VEIIK AU range.",
    ...
    seoTitle: 'VEIIK Australia — 7000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'Panda Australia — 2500 Puff Entry Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Waka Smash earns its name from the sturdier-than-average build quality. The shell uses reinforced construction that survives drops and tumbles better than typical plastic disposables. The Smash 6000 is USB-C rechargeable with dual mesh coil engineering. AussieVapes stocks the Waka Smash AU range.",
    ...
    seoTitle: 'Waka Smash Australia — 6000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Yooz Ultra 15000 is the brand's flagship — 15,000 puffs of e-liquid, dual mesh coil engineering, 850mAh USB-C rechargeable battery, and a premium aluminium-bodied industrial design. The brand positions itself in the premium tier alongside Alfakher Crown Bar and HQD Cuvie Slick. AussieVapes stocks the Yooz Ultra range.",
    ...
    seoTitle: 'Yooz Australia — Ultra 15000 Disposables | AussieVapes',
  ...
  make({
    ...
    seoTitle: 'Bimo Australia — Crystal 12000 Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Adalya is one of the world's most respected shisha tobacco brands, particularly known for its rich, layered flavour development. The Adalya disposable vape line — Love 66 and Two Apples in 16,000-puff format — translates the brand's shisha flavour expertise into the modern disposable format. AussieVapes stocks the Adalya AU range.",
    ...
    seoTitle: 'Adalya Australia — 16000 Puff Shisha Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Funky Land takes a deliberately playful approach — vibrant colours, bold packaging, and fun branding sit alongside dependable mid-range hardware. The Funky Land 6000 is USB-C rechargeable with a mesh coil. Flavours lean toward the fun, fruity end of the spectrum. AussieVapes stocks the Funky Land AU range.",
    ...
    seoTitle: 'Funky Land Australia — 6000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Golit 15000 competes in the premium long-life disposable tier with one key differentiator: price. The device matches the puff count and rechargeable hardware of brands like Alfakher Crown Bar 15000 and HQD Cuvie Slick at a noticeably lower price point. Flavour engineering is solid if not exceptional. AussieVapes stocks the Golit AU range.",
    ...
    seoTitle: 'Golit Australia — 15000 Puff Disposables | AussieVapes',
  ...
  make({
    ...
    longDescription:
      "Leafbar Platinum is positioned as a premium-tier brand competing with the likes of RELX MagicGo and HQD Cuvie Slick in the refined-hardware segment. The platinum line uses higher-grade internal components, more uniform coil winding, and a more sophisticated flavour development approach than mid-tier brands. AussieVapes stocks the Leafbar Platinum AU range.",
    ...
    seoTitle: 'Leafbar Platinum Australia — Premium Disposables | AussieVapes',
