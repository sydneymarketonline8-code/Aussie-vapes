...
export const PUFF_RANGES: PuffRange[] = [
  {
    ...
    longDescription:
      "Aussie Vape Hub' starter range covers entry-level disposable vapes under 2,500 puffs. Ideal for ex-smokers testing the waters, casual vapers who want a small device, or anyone after the lowest per-device price point. Most starter vapes are non-rechargeable and run on a built-in battery designed to last the full puff count.",
    seoTitle: 'Starter Vapes Under 2,500 Puffs Australia | Aussie Vape Hub',
    seoDescription:
      'Browse compact starter disposable vapes under 2,500 puffs at Aussie Vape Hub. Perfect for first-time AU vapers. Same-day Sydney shipping.',
    keywords: [
      'starter vape australia',
      'cheap disposable vape australia',
      'small vape australia',
      'aussie vape hub starter',
  ...
  },
  {
    ...
    longDescription:
      "Mid-range Aussie Vape Hub disposables — from the IGET Bar 3500 to the Gunnpod Plus 4500 and HQD Slick 6000 — strike the best balance between cost and longevity. Most are USB-C rechargeable with mesh coil systems, lasting 5-10 days for a moderate vaper. This is the most-shopped puff range at Aussie Vape Hub.",
    seoTitle: 'Mid-Range Disposable Vapes 2,500-6,000 Puffs Australia | Aussie Vape Hub',
    seoDescription:
      'Shop mid-range disposable vapes 2,500-6,000 puffs at Aussie Vape Hub. IGET Bar, Gunnpod, HQD and more. Same-day Sydney dispatch.',
    keywords: [
      'mid range disposable vape australia',
      '3500 puff vape australia',
      '5000 puff vape australia',
      '6000 puff vape australia',
      'aussie vape hub mid range',
    ],
    icon: ScaleIcon,
  },
  {
    ...
    longDescription:
      'High-puff Aussie Vape Hub disposables (6,000-12,000 puffs) cover the workhorse tier favoured by experienced vapers. The IGET Bar Plus 6000, Alfakher Crown Bar 8000, Gunnpod Moss 8000 and IGET One 12,000 all live here. Every device in this range is USB-C rechargeable, with dual mesh coil systems and adjustable airflow on most models.',
    seoTitle: 'High-Puff Disposable Vapes 6,000-12,000 Australia | Aussie Vape Hub',
    seoDescription:
      'Shop high-puff disposable vapes 6,000-12,000 puffs at Aussie Vape Hub. IGET Bar Plus, Alfakher 8000, IGET One 12000. Same-day Sydney dispatch.',
    keywords: [
  ...
  },
  {
    ...
    longDescription:
      'Ultra-puff Aussie Vape Hub disposables (12,000+ puffs) are the longest-life devices on the Australian market. The Alfakher Crown Bar 15,000, ELUX 15,000, HQD Cuvie Slick 20,000 and Kuz Flow 25,000 all live here. These are the best per-puff value, particularly for heavy vapers — a single device can last 2-4 weeks of moderate use.',
    seoTitle: 'Ultra-Puff Vapes 12,000+ Puffs Australia | Aussie Vape Hub',
    seoDescription:
      'Shop ultra-puff disposable vapes 12,000+ puffs at Aussie Vape Hub. 15K, 20K and 25K puff devices. Same-day Sydney dispatch.',
    keywords: [
