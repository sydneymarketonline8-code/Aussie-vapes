  ...
  <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="background: #ffffff; max-width: 600px; width: 100%; border: 1px solid #e5e5e5; border-radius: 4px;">
    ...
    <tr><td style="padding: 20px 28px 28px;">
      ...
      <p style="margin: 18px 0 0; font-size: 12px; color: #888; line-height: 1.5;">
        Questions? Reply to this email or contact <a href="mailto:sales@aussievapehub.com.au" style="color: #ff0000;">sales@aussievapehub.com.au</a> with your reference code.
      </p>
    </td></tr>
  </table>
</body></html>`.trim()
...
Reference: ${p.reference}   (include in the transaction note)`,
  ...
  return sendEmail({
    ...
    html,
    text,
    replyTo: 'sales@aussievapehub.com.au',
  })
}
...
<div style="border: 2px solid #111; border-radius: 4px; padding: 16px;">
  ...
  <p style="font-size: 11px; color: #888; margin: 12px 0 0;">Email <a href="mailto:sales@aussievapehub.com.au" style="color: #ff0000;">sales@aussievapehub.com.au</a> with your reference code once you've broadcast the transaction.</p>
</div>`.trim()
}
