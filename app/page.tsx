...
export const metadata: Metadata = {
  ...buildSiteMetadata(),
  title: "Aussie Vape Hub — Australia's #1 Online Vape Store | Disposables, Pods, E-Liquid",
  description:
    "Aussie Vape Hub is Australia's #1 online vape store. Shop authentic disposable vapes, pod systems, nicotine salts and e-liquids from IGET, Alfakher, HQD, Gunnpod, Lost Mary and 35+ brands. Same-day Sydney dispatch, free shipping over $300.",
...
export default async function HomePage() {
  ...
  const slides: HeroSlide[] = [
    {
      ...
      subheading:
        'Premium 6,000-puff rechargeable disposable. Mesh coil flavour, 20mg salt nic, fast Australia-wide shipping from Aussie Vape Hub.',
    ...
    },
    {
      ...
      subheading:
        'The ultimate big-puff disposable. Adjustable airflow, mega capacity, 15+ flavour options always in stock at Aussie Vape Hub.',
    ...
    },
    {
      ...
      subheading:
        'Sleek pocket-friendly design with USB-C charging. Fresh fruit & menthol profiles, exclusive to Aussie Vape Hub.',
  ...
  return (
    <>
      ...
      {/* SEO content block — Aussie Vape Hub topical authority */}
      <section className="py-14 bg-soft-100 border-t border-line">
        <div className="container-site max-w-3xl">
          ...
          <h1 className="font-display text-3xl font-bold text-ink mb-4 lowercase">
            aussie vape hub — australia&apos;s #1 online vape store
          </h1>
          <div className="space-y-4 text-body text-sm leading-relaxed">
            <p>
              <strong>Aussie Vape Hub</strong> is the largest online vape store in Australia, stocking 2,000+ authentic products
              ...
              or cloud-friendly{' '}
              <a href="/category/e-liquids" className="text-price font-semibold hover:underline">freebase e-liquids</a>, Aussie Vape Hub has the deepest in-stock range on the Australian market — all dispatched same-day from our Sydney warehouse.
            </p>
            <p>
              The Aussie Vape Hub catalogue covers every major brand Australian vapers actually buy:{' '}
            ...
            <p>
              Why do Australians choose Aussie Vape Hub? Free shipping on orders over $300, express options to every state and territory, real Australian customer support Mon–Fri 9am–5pm AEST, and the deepest in-stock selection of any AU vape retailer. Same-day Sydney dispatch on weekday orders before 2pm AEST.
            </p>
            <p>
              Browse the full{' '}
              <a href="/brands" className="text-price font-semibold hover:underline">Aussie Vape Hub brand directory</a>{' '}
              to shop by manufacturer, or jump straight into our category pages above. New arrivals land every week — bookmark Aussie Vape Hub to stay across the latest drops.
            </p>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-line">
            <h2 className="font-display text-base font-bold text-ink mb-3 uppercase tracking-wider">
              Popular Aussie Vape Hub searches
            </h2>
            <div className="flex flex-wrap gap-2">
              {[
                { label: 'Aussie Vape Hub online', href: '/category/disposable-vapes' },
                { label: 'Aussie Vape Hub store', href: '/brands' },
                { label: 'Australia disposable vapes', href: '/category/disposable-vapes' },
                { label: 'Australia pod systems', href: '/category/pod-systems' },
                { label: 'Aussie Vape Hub Sydney', href: '/category/disposable-vapes' },
                { label: 'Cheap vapes Australia', href: '/sale' },
                { label: 'IGET Aussie Vape Hub', href: '/brand/iget' },
                { label: 'HQD Aussie Vape Hub', href: '/brand/hqd' },
                { label: 'Alfakher Aussie Vape Hub', href: '/brand/alfakher' },
                { label: 'Aussie Vape Hub free shipping', href: '/' },
              ].map(({ label, href }) => (
                <a
                  key={label}
                  href={href}
