      ...
      <section className="container-site py-14 grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="bg-white border border-line rounded-sm p-8 space-y-5">
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex items-start gap-3"><PhoneIcon className="h-5 w-5 text-ink flex-shrink-0 mt-0.5" /><a href="tel:+61489929556" className="hover:text-price"><strong>+61 489 929 556</strong></a></li>
