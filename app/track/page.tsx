...
export const metadata: Metadata = {
  title: 'Track Your VapeHub Vapes Australia Order',
  description: 'Track the status of your VapeHub Vapes Australia order. Enter your order number and email to see real-time courier tracking.',
    ...
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'VapeHub Vapes Australia', href: '/' }, { label: 'Order Tracking' }]} />
          <h1 className="font-display text-4xl lg:text-5xl font-bold text-ink mt-4 mb-3 lowercase">
            track your vapehub vapes australia order
          </h1>
          <p className="text-body max-w-2xl leading-relaxed">
            Enter your VapeHub Vapes Australia order number and the email address used for the order to see real-time tracking.
          </p>
        </div>
      </section>
      ...
      <section className="container-site py-14 max-w-xl">
        <form className="bg-white border border-line rounded-sm p-6 space-y-4">
          ...
          <button type="submit" className="btn-primary w-full">Track My VapeHub Vapes Australia Order</button>
          <p className="text-xs text-mute text-center">
            Lost your order number? Check the confirmation email from VapeHub Vapes Australia or <Link href="/contact" className="text-price font-semibold hover:underline">contact us</Link>.
          </p>
        </form>
      </section>
    </>
