...
export const metadata: Metadata = {
  title: 'VapeHub Vapes Australia Bulk & Wholesale — B2B Vape Supply Australia',
  description:
    "VapeHub Vapes Australia supplies bulk and wholesale vape orders to Australian businesses. Convenience stores, tobacconists, event organisers and resellers welcome.",
  keywords: [
    'vapehub vapes australia wholesale',
    ...
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'VapeHub Vapes Australia', href: '/' }, { label: 'Bulk & Wholesale' }]} />
          ...
          <h1 className="font-display text-4xl lg:text-5xl font-bold text-ink mt-1 mb-3 lowercase">
            vapehub vapes australia bulk &amp; wholesale
          </h1>
          <p className="text-body max-w-2xl leading-relaxed">
            Australian retailer, tobacconist, convenience store or event organiser? VapeHub Vapes Australia supplies bulk
      ...
      <section className="container-site py-14 grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div>
          <h2 className="font-display text-2xl font-bold text-ink mb-4 lowercase">why work with vapehub vapes australia</h2>
          <ul className="space-y-3 text-body">
            {[
              { t: 'Authorised AU distributor', b: 'Every VapeHub Vapes Australia wholesale product is sourced through authorised channels with full batch authentication.' },
              { t: 'Tiered wholesale pricing', b: 'Volume discounts unlock at $1k / $5k / $10k AUD monthly purchase tiers.' },
              { t: 'Net-30 terms (approved accounts)', b: 'Approved VapeHub Vapes Australia wholesale partners can apply for net-30 payment terms.' },
              { t: 'Dedicated account manager', b: 'Direct line to a real VapeHub Vapes Australia contact — not a ticketing system.' },
