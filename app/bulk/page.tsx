...
export const metadata: Metadata = {
  title: 'Aussie Vapes Bulk & Wholesale — B2B Vape Supply Australia',
  description:
    "Aussie Vapes supplies bulk and wholesale vape orders to Australian businesses. Convenience stores, tobacconists, event organisers and resellers welcome.",
  keywords: [
    'aussie vapes wholesale',
    'aussie vapes bulk',
    ...
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'Aussie Vapes', href: '/' }, { label: 'Bulk & Wholesale' }]} />
          ...
          <h1 className="font-display text-4xl lg:text-5xl font-bold text-ink mt-1 mb-3 lowercase">
            aussie vapes bulk &amp; wholesale
          </h1>
          <p className="text-body max-w-2xl leading-relaxed">
            Australian retailer, tobacconist, convenience store or event organiser? Aussie Vapes supplies bulk
      ...
      <section className="container-site py-14 grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div>
          <h2 className="font-display text-2xl font-bold text-ink mb-4 lowercase">why work with aussie vapes</h2>
          <ul className="space-y-3 text-body">
            {[
              { t: 'Authorised AU distributor', b: 'Every Aussie Vapes wholesale product is sourced through authorised channels with full batch authentication.' },
              { t: 'Tiered wholesale pricing', b: 'Volume discounts unlock at $1k / $5k / $10k AUD monthly purchase tiers.' },
              { t: 'Net-30 terms (approved accounts)', b: 'Approved Aussie Vapes wholesale partners can apply for net-30 payment terms.' },
              { t: 'Dedicated account manager', b: 'Direct line to a real Aussie Vapes contact — not a ticketing system.' },
        ...
        <div className="bg-white border border-line rounded-sm p-6">
          <h2 className="font-display text-xl font-bold text-ink uppercase tracking-wide mb-4">Apply for an Aussie Vapes Wholesale Account</h2>
          <form className="space-y-4">
            ...
            <p className="text-xs text-mute text-center">Aussie Vapes typically responds to wholesale applications within 1 business day.</p>
          </form>
        </div>
      </section>
    </>
