          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mt-5">
            <div>
              <p className="font-display text-xs uppercase tracking-[0.3em] text-price font-bold mb-2">
                {allProducts.length.toLocaleString()} VapeHub Vapes Australia In This Range
              </p>
      ...
      <section className="container-site py-12">
        {allProducts.length === 0 ? (
          <p className="text-mute text-center py-20">
            No VapeHub Vapes Australia products currently in the {r.shortName.toLowerCase()} puff range. Try a different range above.
          </p>
        ) : (
          <>
      ...
      <section className="bg-soft-100 border-t border-line py-12">
        <div className="container-site max-w-3xl">
          <h2 className="font-display text-2xl font-bold text-ink mb-4 lowercase">
            about {r.shortName.toLowerCase()} puff vapes at vapehub vapes australia
          </h2>
          ...
          <div className="mt-6 flex items-start gap-2 text-xs text-body">
            ...
            All VapeHub Vapes Australia products in this range are authentic AU stock, same-day Sydney dispatch on weekday orders before 2pm AEST.
          </div>
        </div>
      </section>
    </>
