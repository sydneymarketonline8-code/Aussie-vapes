...
export const metadata: Metadata = {
  title: 'Aussie Vapes Blog — Vape News, Reviews & Guides',
  description:
    "Australian vape news, product reviews, beginner guides and industry updates from Aussie Vapes — the country's #1 online vape store.",
  keywords: [
    'aussie vapes blog',
    'australian vape news',
    'vape reviews australia',
    'vape guides australia',
    'aussie vapes articles',
  ],
...
const POSTS = [
  ...
  },
  {
    slug: 'shop-by-brand',
    href: '/brands',
    title: '40+ Aussie Vapes Brands At A Glance',
    excerpt: 'A quick tour of every disposable and pod brand stocked at Aussie Vapes — IGET, Alfakher, HQD, Gunnpod, Lost Mary and more.',
    category: 'Brands',
    date: '2026-04-22',
  },
  {
    ...
    excerpt: "The IGET Bar Plus 6000 has been the most popular Aussie Vapes disposable for two years running. Here's why it dominates the AU mid-range.",
    category: 'Reviews',
    date: '2026-04-10',
  },
  {
    ...
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'Aussie Vapes', href: '/' }, { label: 'Blog' }]} />
          ...
          <p className="text-body max-w-2xl leading-relaxed">
            Australian vape news, product reviews, beginner guides and industry updates from the Aussie Vapes team.
          </p>
        </div>
      </section>
      ...
      <section className="container-site py-14">
        ...
        <div className="mt-10 text-center">
          <p className="text-body text-sm mb-3">More Aussie Vapes content coming soon — bookmark this page.</p>
