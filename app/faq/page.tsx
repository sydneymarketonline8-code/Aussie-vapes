...
const FAQ_GROUPS: { title: string; items: { question: string; answer: string }[] }[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Vapes Australia is an online-only store. We don't take phone orders for security reasons, but our support team is happy to help you place an online order if you call us at +61 485 882 439.",
      },
    ],
  },
  {
