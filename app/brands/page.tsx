...
export const metadata: Metadata = {
  title: 'VapeHub Vapes Australia Brands — Shop By Brand In Australia | VapeHub Vapes Australia',
  description:
    'Browse every vape brand stocked at VapeHub Vapes Australia — Australia\'s #1 online vape store. IGET, Alfakher, HQD, Gunnpod, Lost Mary, Vozol, RELX and 35+ more. Authentic AU stock with same-day Sydney shipping.',
  keywords: [
    'vapehub vapes australia brands',
    'vapehub vapes australia shop by brand',
    'vape brands',
    'vape brands australia',
    'best vape brands australia',
    'iget vapehub vapes australia',
    'hqd vapehub vapes australia',
    'alfakher vapehub vapes australia',
    'gunnpod vapehub vapes australia',
  ],
  alternates: { canonical: '/brands' },
  openGraph: {
    title: 'VapeHub Vapes Australia Brands — Shop By Brand In Australia | VapeHub Vapes Australia',
    description:
      'Browse every vape brand stocked at VapeHub Vapes Australia. Authentic AU stock with same-day Sydney shipping.',
  },
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center mt-4">
            <div>
              <p className="font-display text-xs uppercase tracking-[0.3em] text-price font-bold mb-2">
                {BRANDS.length}+ Vape Brands At VapeHub Vapes Australia
              </p>
              <h1 className="font-display text-4xl lg:text-5xl font-bold text-ink mt-1 mb-3 lowercase">vapehub vapes australia — shop by brand</h1>
              <p className="text-body leading-relaxed">
                <strong>VapeHub Vapes Australia</strong> is Australia&apos;s largest authorised stockist of the world&apos;s leading vape brands.
                Browse every brand carried at VapeHub Vapes Australia — IGET, Alfakher, HQD, Gunnpod, Lost Mary, Vozol and 35+ more —
      ...
      <section className="bg-soft-100 border-t border-line py-12">
        <div className="container-site max-w-3xl text-center">
          ...
          <p className="text-body text-sm leading-relaxed">
            Every brand sold at VapeHub Vapes Australia is sourced through authorised Australian distribution channels. We verify
