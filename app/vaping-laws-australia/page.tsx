...
export const metadata: Metadata = {
  title: 'Vaping Laws In Australia 2026 — Aussie Vapes Compliance Guide',
  description:
    "Complete guide to Australian vaping laws in 2026. TGA prescription model, legal nicotine strengths, age limits, importation rules — Aussie Vapes breaks it all down.",
  keywords: [
...
const ARTICLE_JSON_LD = {
  ...
  '@type': 'Article',
  headline: 'Vaping Laws In Australia 2026 — Aussie Vapes Compliance Guide',
    ...
    <>
      ...
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'Aussie Vapes', href: '/' }, { label: 'AU Vaping Laws' }]} />
          ...
          <p className="text-body max-w-2xl leading-relaxed">
            Australia&apos;s vaping laws are unique and frequently updated. This Aussie Vapes guide explains the current
      ...
      <article className="container-site py-14 grid grid-cols-1 lg:grid-cols-3 gap-10">
        <div className="lg:col-span-2 space-y-8 prose-content">
          ...
          <section>
            ...
            <p className="text-body leading-relaxed mb-3">
              ...
              vapes — including every Aussie Vapes disposable — are capped at <strong>20mg/mL (2%)</strong>, which is
            ...
            <p className="text-body leading-relaxed">
              ...
              direct AU consumer sale. Aussie Vapes only stocks compliant products.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-body leading-relaxed">
              ...
              older</strong>. Aussie Vapes enforces an age-gate on every site visit and prescription confirmation at
          ...
          <section>
            ...
            <p className="text-body leading-relaxed">
              Aussie Vapes is a domestic Australian retailer — we don&apos;t ship internationally and your purchase
          ...
          <section>
            ...
            <p className="text-body leading-relaxed mt-3">
              Aussie Vapes recommends vaping only in your home or designated outdoor smoking areas. Check your specific
          ...
          <section>
            ...
            <ul className="space-y-2 text-sm text-body">
              ...
              <li>• <strong>Mid-2025:</strong> Online consumer retailers like Aussie Vapes continue operating under prescription model with prescription confirmation at checkout</li>
            </ul>
            <p className="text-body leading-relaxed mt-3">
              The regulatory environment continues to evolve. Aussie Vapes monitors all changes and updates compliance
        ...
        <aside className="lg:sticky lg:top-24 h-fit space-y-6">
          ...
          <div className="bg-soft-100 border border-line rounded-sm p-6">
            <h3 className="font-display text-sm font-bold text-ink uppercase tracking-wider mb-3">Related Aussie Vapes Pages</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/contact" className="text-body hover:text-price">Talk to Aussie Vapes</Link></li>
            </ul>
          </div>
        </aside>
      </article>
