      ...
      <div className="container-site py-20 max-w-xl">
        <div className="bg-amber-50 border border-amber-200 rounded-sm p-8 text-center">
          ...
          <p className="text-body text-sm mb-6">
            Your cart subtotal is currently <strong>${subtotal.toFixed(2)}</strong>. We have a ${minOrder.minimum} minimum order across VapeHub Vapes Australia — top up your cart to continue.
          </p>
