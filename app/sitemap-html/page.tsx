...
export const metadata: Metadata = {
  title: 'Vapes Australia Sitemap — All Pages, Brands & Categories',
  description: 'Complete sitemap of Vapes Australia. Browse every category, brand, location and information page in one place.',
...
const RESOURCES = [
  { label: 'Vapes Australia FAQ', href: '/faq' },
...
const ACCOUNT = [
  ...
  { label: 'Search Vapes Australia', href: '/search' },
]
    ...
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'Vapes Australia', href: '/' }, { label: 'Sitemap' }]} />
          <h1 className="font-display text-4xl lg:text-5xl font-bold text-ink mt-4 mb-3 lowercase">
            vapes australia sitemap
          </h1>
          <p className="text-body max-w-2xl leading-relaxed">
            Every page on Vapes Australia, organised. The full XML sitemap for search engines lives at{' '}
      ...
      <section className="container-site py-14 space-y-12">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <Col title="My Vapes Australia" items={ACCOUNT} />
        ...
        <div>
          <h2 className="font-display text-2xl font-bold text-ink mb-4 lowercase">all {BRANDS.length} vapes australia brands</h2>
