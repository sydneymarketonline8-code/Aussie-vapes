...
export const metadata: Metadata = {
  title: 'About Aussie Vapes — Australia\'s #1 Online Vape Store',
  description:
    "Discover Aussie Vapes — Australia's largest authorised online vape retailer. 2,000+ authentic disposable vapes, pod systems and e-liquids shipped same-day from Sydney.",
  keywords: [
    'about aussie vapes',
    'aussie vapes story',
    ...
    'aussie vapes sydney',
    'who is aussie vapes',
    'aussie vapes about us',
  ],
  alternates: { canonical: '/about' },
  openGraph: {
    title: 'About Aussie Vapes — Australia\'s #1 Online Vape Store',
    description:
      "Discover Aussie Vapes — Australia's largest authorised online vape retailer.",
  },
}
    ...
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'Aussie Vapes', href: '/' }, { label: 'About Us' }]} />
          ...
          <p className="text-body text-base leading-relaxed max-w-2xl">
            <strong>Aussie Vapes</strong> is built by Australians, for Australians. We&apos;re the largest authorised
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            ...
            <div className="space-y-4 text-body leading-relaxed">
              <p>
                Aussie Vapes was founded with a simple mission: bring authentic, well-priced vape products to
                ...
                prescription model. So we built Aussie Vapes — locally operated, locally stocked, and entirely
                compliant with Australian regulations.
              </p>
              <p>
                Today, Aussie Vapes serves customers in every state and territory. From our Sydney warehouse we
          ...
          <div>
            <h2 className="font-display text-2xl font-bold text-ink mb-4 lowercase">what makes aussie vapes different</h2>
          ...
          <div>
            ...
            <div className="space-y-4 text-body leading-relaxed text-sm">
              <p>
                Aussie Vapes operates entirely within Australia&apos;s TGA prescription framework for nicotine vaping
              ...
              <p>
                That said, nicotine is addictive and vaping is not risk-free. Aussie Vapes products are for adults 18+
