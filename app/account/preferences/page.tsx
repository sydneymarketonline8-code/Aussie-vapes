...
const NOTIFICATION_PREFS = [
  ...
  { id: 'promotions', label: 'Sales & promotions', body: 'Aussie Vapes sales, limited-time discounts and pack-deal alerts.', defaultOn: true },
  { id: 'new-arrivals', label: 'New arrivals', body: 'Brand drops and freshly-landed disposables.', defaultOn: false },
  { id: 'newsletter', label: 'Aussie Vapes newsletter', body: 'Monthly wrap of new brands, AU vape news and member tips.', defaultOn: false },
    ...
    <div className="space-y-5">
      <header className="bg-white border border-line rounded-sm p-5">
        ...
        <p className="text-sm text-mute mt-1">
          Choose which Aussie Vapes emails and notifications you want to receive. You can change these any time.
        </p>
      </header>
      ...
      <section className="bg-soft-100 border border-line rounded-sm p-5">
        ...
        <p className="text-sm text-body mb-3 max-w-2xl">
          You can opt out of all Aussie Vapes marketing communications in one click. You&apos;ll still receive
