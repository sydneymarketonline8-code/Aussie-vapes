    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        ...
        <div className="bg-white border border-line rounded-sm p-5">
          ...
          <p className="text-xs text-mute mt-1">Aussie Vapes member</p>
        </div>
      </section>
      ...
      <section className="bg-white border border-line rounded-sm">
        ...
        <div className="px-5 py-10 text-center">
          ...
          <p className="text-sm text-mute mb-5 max-w-sm mx-auto">
            When you place your first Aussie Vapes order it will appear here with full tracking and reorder options.
          </p>
