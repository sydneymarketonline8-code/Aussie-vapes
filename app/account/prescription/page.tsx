    ...
    <div className="space-y-5">
      <header className="bg-white border border-line rounded-sm p-5">
        ...
        <p className="text-sm text-mute mt-1">
          Upload your Australian nicotine prescription once and Aussie Vape Hub will keep it on file for every future
      ...
      <div className="bg-warning/10 border border-warning/30 rounded-sm p-4 flex items-start gap-3">
        ...
        <div className="text-sm">
          ...
          <p className="text-body">
            You can still browse Aussie Vape Hub, but nicotine purchases require a valid AU prescription at checkout.{' '}
        ...
        <form className="space-y-4">
          ...
          <label className="flex items-start gap-3 cursor-pointer p-3 rounded-sm border border-line bg-soft-100">
            ...
            <span className="text-sm text-body">
              I confirm this is a valid Australian prescription issued to me, and I understand Aussie Vape Hub is required to
