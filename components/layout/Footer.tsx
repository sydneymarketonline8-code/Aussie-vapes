...
const account = [
  ...
  { label: 'About VapeHub Vapes Australia', href: '/about' },
...
const locations = [
  { label: 'VapeHub Vapes Australia Sydney', href: '/vapehub-vapes-australia/sydney' },
  { label: 'VapeHub Vapes Australia Melbourne', href: '/vapehub-vapes-australia/melbourne' },
  { label: 'VapeHub Vapes Australia Brisbane', href: '/vapehub-vapes-australia/brisbane' },
  { label: 'VapeHub Vapes Australia Perth', href: '/vapehub-vapes-australia/perth' },
  { label: 'VapeHub Vapes Australia Adelaide', href: '/vapehub-vapes-australia/adelaide' },
  { label: 'All Locations', href: '/vapehub-vapes-australia' },
]
    ...
    <footer className="mt-20 bg-soft-100 border-t border-line">
      ...
      <div className="bg-ink text-white">
        <div className="container-site py-8 grid grid-cols-1 lg:grid-cols-2 gap-6 items-center">
          <div>
            <h3 className="font-display text-2xl font-bold uppercase tracking-wide">Join the VapeHub Vapes Australia Club</h3>
            <p className="text-sm text-white/70 mt-1">Get 10% off your first VapeHub Vapes Australia order plus exclusive deals straight to your inbox.</p>
          </div>
      ...
      <div className="border-t border-line bg-white">
        <div className="container-site py-6">
          <p className="font-display text-xs uppercase tracking-[0.3em] text-mute font-bold text-center mb-3">Top Brands At VapeHub Vapes Australia</p>
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2">
            {['IGET', 'Alfakher', 'HQD', 'Gunnpod', 'Lost Mary', 'Vozol', 'RELX', 'Elux', 'Mr Fog', 'AliBarBar', 'JNR', 'Serein'].map((b) => (
              <a
                ...
                title={`${b} at VapeHub Vapes Australia`}
              >
                {b}
              </a>
            ))}
      ...
      <div className="container-site py-14 grid grid-cols-2 lg:grid-cols-5 gap-10">
        ...
        <div className="col-span-2">
          ...
          <p className="text-body text-sm leading-relaxed mb-5 max-w-md">
            <strong>VapeHub Vapes Australia</strong> is Australia&apos;s #1 online vape store. Authentic disposable vapes from IGET, Alfakher, HQD, Gunnpod, Lost Mary and 35+ more brands — shipped same-day from our Sydney warehouse, free across Australia on orders over $300.
          </p>
          ...
          <ul className="space-y-2.5 text-sm">
            ...
            <li className="flex items-start gap-2 text-body">
              ...
              <a href="tel:+61468188347" className="hover:text-price">+61 468 188 347</a>
            </li>
            <li className="flex items-start gap-2 text-body">
      ...
      <div className="border-t border-line bg-white">
        <div className="container-site py-6">
          <p className="font-display text-xs uppercase tracking-[0.3em] text-mute font-bold text-center mb-3">VapeHub Vapes Australia Locations</p>
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
      ...
      <div className="border-t border-line bg-ink text-white">
        <div className="container-site py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/70 text-center sm:text-left">
            © {new Date().getFullYear()} VapeHub Vapes Australia. All rights reserved. ABN: 00 000 000 000 — Australia&apos;s #1 Online Vape Store
          </p>
        ...
        <div className="container-site pb-4">
          <p className="text-[10px] text-white/50 text-center leading-relaxed">
            Nicotine products are highly addictive and not risk-free. For adult use only (18+). VapeHub Vapes Australia does not sell nicotine products without a valid Australian prescription where required by law. Please vape responsibly.
          </p>
        </div>
      </div>
    </footer>
