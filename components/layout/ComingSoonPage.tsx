...
export default function ComingSoonPage({ breadcrumb, title, intro, body, ctaHref = '/contact', ctaLabel = 'Contact Aussie Vapes' }: ComingSoonProps) {
  return (
    <>
      <section className="bg-soft-100 border-b border-line">
        <div className="container-site py-10">
          <Breadcrumb crumbs={[{ label: 'Aussie Vapes', href: '/' }, { label: breadcrumb }]} />
      ...
      <section className="container-site py-14 max-w-2xl">
        ...
        <div className="bg-soft-100 border border-line rounded-sm p-8 text-center">
          ...
          <p className="text-body text-sm leading-relaxed mb-6">
            This Aussie Vapes feature is launching soon. In the meantime, our team can help you with anything you need.
          </p>
        ...
        <div className="mt-10">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
            ...
            <li><Link href="/brands" className="text-body hover:text-price">Browse All Aussie Vapes Brands</Link></li>
            <li><Link href="/sale" className="text-body hover:text-price">Current Aussie Vapes Sale</Link></li>
