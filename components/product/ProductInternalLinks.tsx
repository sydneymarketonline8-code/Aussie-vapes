 ...
 * product's brand, category, format and the surrounding Aussie Vapes site.
 */
export default function ProductInternalLinks({ product }: ProductInternalLinksProps) {
  ...
  if (product.isSale) {
    links.push({ label: 'Current Aussie Vapes Sale', href: '/sale' })
  } else {
    links.push({ label: 'Aussie Vapes Sale', href: '/sale' })
  }
  ...
  links.push({ label: 'Aussie Vapes FAQ', href: '/faq' })
